...
export const bitcoin = <i className="fa-brands fa-bitcoin"></i>; // Brands icon
export const piggy = <i className="fa-solid fa-piggy-bank"></i>;
export const yt = <i className="fa-brands fa-youtube"></i>; // Brands icon
export const card = <i className="fa-brands fa-cc-visa"></i>; // Brands icon
